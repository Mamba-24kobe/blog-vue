  ...
  <div class="fromInput">
    <el-form :model="userForm" :rules="userRules" ref="userForm">
      ...
      <el-form-item size="medium" prop="avatarImg" v-if="isUpload">
        ...
        >
          <img v-if="userForm.avatarImg" :src="userForm.avatarImg" class="logo-img" alt="Mamba头像缩略图" />
...
<script>
import {validateUrl,validateEmail,validateQQEmail}  from '../plugins/validate'
export default {
  props: {
